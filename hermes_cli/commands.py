...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("list-model", "List only models backed by credentials on this profile", "Configuration",
               aliases=("list-models",), args_hint="[provider] [--refresh]", busy_policy="dispatch"),
    ...
    CommandDef("usage", "Show token usage and provider account limits; `global` checks all profiles", "Info",
               args_hint="[global|provider|reset [--force]]", busy_policy="dispatch"),
